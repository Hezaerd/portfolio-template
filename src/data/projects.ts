...
export const projects: Project[] = [
  {
    ...
    images: ["/placeholder-engine-1.jpg", "/placeholder-engine-2.jpg"],
  },
  {
    ...
    challenges: [
      ...
      "Creating educational content that's both accurate and engaging",
    ],
    technologies: [
      "C#",
      "Unity 2022.3",
    ...
    images: ["/placeholder-physics-1.jpg", "/placeholder-physics-2.jpg"],
  },
  {
    ...
    images: ["/placeholder-platformer-1.jpg", "/placeholder-platformer-2.jpg"],
  },
  {
    ...
    challenges: [
      "Managing DirectX 12's explicit resource management and synchronization",
    ...
    images: ["/placeholder-rendering-1.jpg", "/placeholder-rendering-2.jpg"],
  },
  {
    ...
    longDescription:
      "A comprehensive pathfinding solution designed for game developers, featuring multiple pathfinding algorithms, navigation mesh generation, and dynamic obstacle avoidance. The toolkit is designed to be engine-agnostic while providing Unity-specific bindings for ease of use.",
    tags: ["C#", "Unity", "AI"],
    highlight: "AI Pathfinding Toolkit",
    features: [
      "Multiple pathfinding algorithms (A*, Dijkstra, Flow Fields)",
    ...
    images: ["/placeholder-ai-1.jpg", "/placeholder-ai-2.jpg"],
  },
  {
    ...
    longDescription:
      "A comprehensive suite of development tools designed to streamline game development workflows. Includes asset pipeline automation, level design tools, debugging utilities, and team collaboration features. These tools have proven to reduce development time by 40% and improve team productivity.",
    tags: ["C#", "Unity", "Tools"],
    ...
    images: ["/placeholder-tools-1.jpg", "/placeholder-tools-2.jpg"],
  },
];
